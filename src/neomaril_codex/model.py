...
class NeomarilModel(BaseNeomaril):
  ...
  def __init__(self, password:str, model_id:str, group:str="datarisk", group_token:Optional[str]=None, test_enviroment:bool=True) -> None:
    """Class to manage Models deployed inside Neomaril
  ...
  def set_token(self, group_token:str) -> None:
    ...
    self.__token = group_token
    self.log.info(f"Token for group {self.group} added.")

  def predict(self, data:Union[dict, str], group_token:Optional[str]=None) -> Union[dict, NeomarilExecution]:
      ...
      if (group_token is not None) | (self.__token is not None):
        ...
        if self.operation == 'sync':
          ...
          if req.status_code == 202:
            exec_id = re.search(patt, message).group(1)
            return NeomarilExecution('AsyncModel', exec_id, password=self.__credentials, enviroment=self.enviroment)
          else:
...
class NeomarilModelClient(BaseNeomarilClient):
  ...
  def get_model(self, model_id:str, group:str="datarisk", group_token:Optional[str]=None, wait_for_ready:bool=True) -> NeomarilModel:
    ...
    if status in ['Disabled', 'Ready']:
      ...
      return NeomarilModel(self.__credentials, model_id, group=group, test_enviroment=(self.enviroment == "Staging"), group_token=group_token)
    else:
  ...
  def __upload_model(self, model_name:str, model_reference:str, source_file:str, 
                     ...
                     group:Optional[str]=None, extra_files:Optional[list]=None, 
  ...
  def create_model(self, model_name:str, model_reference:str, source_file:str, 
                   model_file:str, requirements_file:str, schema:Optional[Union[str, dict]]=None, 
                   group:str=None, extra_files:Optional[list]=None, 
    ...
    if group:
      ...
      group = 'datarisk'
      self.log.info("Group not informed, using default 'datarisk' group")
    ...
    model_id = self.__upload_model(model_name, model_reference, source_file, 
                        ...
                        extra_files=extra_files, python_version=python_version, 
